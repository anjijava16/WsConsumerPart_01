...
public class GlobalWeatherLocator extends org.apache.axis.client.Service implements NET.webserviceX.www.GlobalWeather {
    ...
    public NET.webserviceX.www.GlobalWeatherSoap getGlobalWeatherSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public NET.webserviceX.www.GlobalWeatherSoap getGlobalWeatherSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            NET.webserviceX.www.GlobalWeatherSoap12Stub _stub = new NET.webserviceX.www.GlobalWeatherSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (NET.webserviceX.www.GlobalWeatherSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                NET.webserviceX.www.GlobalWeatherSoap12Stub _stub = new NET.webserviceX.www.GlobalWeatherSoap12Stub(new java.net.URL(GlobalWeatherSoap12_address), this);
                _stub.setPortName(getGlobalWeatherSoap12WSDDServiceName());
                return _stub;
            }
            if (NET.webserviceX.www.GlobalWeatherSoap.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("GlobalWeatherSoap12".equals(inputPortName)) {
            return getGlobalWeatherSoap12();
        }
        else if ("GlobalWeatherSoap".equals(inputPortName)) {
